...
def main():
    ...
    optimizer = optim.AdamW(model.parameters(), lr=0.003, maximize = False)
    ...
    for epoch in range(num_epochs):
        ...
        for i in range(len(ds)):
           ...
           # output1, output2 = model(inputs)
            ...
            #print(len(output1))
            #print(output1)
            ot = output1.cpu().detach().numpy()[0][0]
            ac = target1.cpu().detach().numpy()
            #print(target2.shape)
            #print(output2.shape)
            #print(output2)
            ...
            if i % 200 == 0 or epoch == num_epochs - 1:
            ...
            #print(f"Epoch [{epoch+1}/{num_epochs}], Loss: {loss:.4f}, Loss1: {loss1:.4}")
        print(f"Epoch [{epoch+1}/{num_epochs}], Loss: {loss:.4f}, Loss1: {loss1:.4}")
